...
# Also used in Python code generated by older ksc versions (0.7 and 0.8)
# to check that the imported runtime is compatible with the generated code.
# Since ksc 0.9, the compatibility check instead uses the API_VERSION constant,
...
# Used in generated Python code (since ksc 0.9) to check that the imported
